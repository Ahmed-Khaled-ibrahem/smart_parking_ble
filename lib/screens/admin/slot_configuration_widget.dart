...
class ConfigurationParkingSlotWidget extends StatefulWidget {
  ...
  const ConfigurationParkingSlotWidget({
    super.key,
    required this.slot,
  ...
  @override
  State<ConfigurationParkingSlotWidget> createState() =>
      _ConfigurationParkingSlotWidgetState();
}

class _ConfigurationParkingSlotWidgetState
    extends State<ConfigurationParkingSlotWidget>
  ...
  Widget build(BuildContext context) {
    ...
    final isConfigured =
        widget.slot.linkedToDevice != null &&
        widget.slot.linkedToDevice!.isNotEmpty;
    final baseColor = isConfigured
        ? const Color(0xFF00088E)
        : const Color(0xFF1B5E20);
    final glowColor = isConfigured
        ? const Color(0xFF118AD5)
